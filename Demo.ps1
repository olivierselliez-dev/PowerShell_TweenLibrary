...
function CreateAnimatedControls {
    ...
    $Script:animatedProgressBar.Location = [System.Drawing.Point]::new($Script:animatedProgressBar.Width * -1 - 10, $labelAnimatedValue.Location.Y + $labelAnimatedValue.Height + 20)
    #endregion
